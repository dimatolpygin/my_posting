 ...
 *    а отклоняется: два прогона на одних и тех же материалах — это дубли в группе.
 ...
 * Планировщик вызывает ровно это.
 *
...
async function executeCycle({ kind, groupIds, limitPerGroup, stepMinutes }) {
  ...
  for (const item of items) {
    ...
    try {
      ...
      // Один из прогонов получил двадцать пять одинаковых отказов подряд и двадцать пять
