...
-- Служебные (schema_migrations, app_meta) созданы раньше.
...
-- по нему дедуп. topic_key — нормализованное название проекта, дедуп по теме.
-- ─────────────────────────────────────────────────────────────────────────────
...
-- request_id связывает запись с логами контейнера.
-- ─────────────────────────────────────────────────────────────────────────────
