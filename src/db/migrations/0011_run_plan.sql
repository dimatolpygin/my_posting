...
-- Главная гарантия: внутри прогона один материал уходит ровно в одну группу.
...
-- Настройки расписания и антиспама. schedule_mode/interval/daily_at засеяны раньше,
