...
/**
 * Группы Одноклассников. Список приходит из postmypost — числовые id руками не вводятся.
 *
 ...
 * наполнении из архива: оно создаёт сразу все публикации, но расписывает их
 * `post_at` на неделю вперёд. По времени создания лимит «10 в день» был бы исчерпан
 * первым же заданием, хотя в группе в этот день выходит ровно столько, сколько положено.
