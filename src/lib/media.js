 ...
 * и живёт минуты. Публикация отложенная — к моменту постинга ссылка мёртвая,
...
export function publicBaseReachable() {
  ...
  return {
    ...
    hint:
      ...
      'Поднимите туннель (рецепт в документации) и подставьте его адрес в PUBLIC_BASE_URL, ' +
 ...
 * на проде — домен. Сборка на лету означает, что смена одной переменной сразу лечит все уже сгенерированные посты, без UPDATE
