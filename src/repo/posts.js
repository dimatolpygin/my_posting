...
/** Готовый пост без обложки — кандидат на генерацию картинки (нужно крону). */
...
/** Готовый пост с обложкой, который ещё никуда не публиковался (кнопка в панели и cron). */
